          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-2">
                ...
                />
                <span className="text-gray-600 font-medium">.app.vbpartners.app</span>
              </div>
              ...
              {!subdomainChecking && subdomainAvailable === true && signupData.subdomain.length >= 3 && (
                <div className="flex items-center gap-2 text-sm text-green-600">
                  ...
                  <span>{signupData.subdomain}.app.vbpartners.app is available!</span>
                </div>
              )}
            ...
            <div className="bg-blue-50 border-2 border-blue-200 rounded-lg p-4 mt-6">
              <p className="text-sm text-gray-700">
                ...
                <span className="text-indigo-600 font-semibold">
                  {signupData.subdomain || 'your-business'}.app.vbpartners.app
                </span>{' '}
